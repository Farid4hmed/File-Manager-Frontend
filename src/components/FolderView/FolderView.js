...
import { getFolders } from '../../api/pin';
...
export default function FolderView(props) {
    ...
    return (
        <div className={styles.container}>
            ...
            <div key={toString(folder._id)} className={styles.bar} style={{borderStyle: currId===folder.folderName?"double": "", borderColor: currId===folder.folderName?"blue":""}} onClick={()=>{handleClick(folder.folderName)}}>
